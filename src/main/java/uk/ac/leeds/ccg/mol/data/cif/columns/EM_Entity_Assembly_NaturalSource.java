...
/**
 * EM_Entity_Assembly_NaturalSource Columns.
 * @author Andy Turner
 */
public class EM_Entity_Assembly_NaturalSource extends Columns {
     ...
     */
    public EM_Entity_Assembly_NaturalSource(Columns_ID id) {
        super(NAME, id);
    }
