...
/**
 * EM_Entity_Assembly_NaturalSource Category.
 * @author Andy Turner
 */
public class EM_Entity_Assembly_NaturalSource extends Category {
     ...
     */
    public EM_Entity_Assembly_NaturalSource(Category_ID id) {
        super(NAME, id);
    }
